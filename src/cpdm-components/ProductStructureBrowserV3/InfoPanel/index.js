...
export default function InfoPanel(props) {
  // const { dataType,type, id, ...reset } = props;
  const { dataType, type, ...reset } = props;
  const id = '448066795039318016';
  ...
  const panels = {
    ...
    usage: <Usage type={type} id={id} data={info} dataType={dataType} {...reset} />,
    sub: <Sub type={type} id={id} data={info} dataType={dataType} {...reset} />,
    standard: <Standard type={type} id={id} data={info} dataType={dataType} {...reset} />,
    components: <Components type={type} id={id} data={info} dataType={dataType} {...reset} />,
    document: <Document type={type} id={id} data={info} dataType={dataType} {...reset} />,
