...
export async function listStatus() {
  return request(`${prefix}/data-packages/status/exchange`);
}
...
export async function getBasicInfo(params) {
  return request(`${prefix}/data-packages/${params.id}/exchange`);
}

export async function getHistory(params) {
  return request(`${prefix}/data-packages/${params.id}/history/exchange`);
}
...
export async function getLocalProcess(params) {
  return request(`${prefix}/data-packages/${params.id}/process/exchange`);
}
